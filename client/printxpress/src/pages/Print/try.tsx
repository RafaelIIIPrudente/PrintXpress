...
//   const [uploadedFiles, setUploadedFiles] = useState<PdfData[] | null>(null);
//   const [selectedPdf, setSelectedPdf] = useState<string>("");
//   const [pdfPrint, setPdfPrint] = useState<string>("");
...
//   return (
//     <div className="bg-cover bg-center h-screen min-h-screen" style={{ backgroundImage: `url(${backgroundImage})` }}>
...
//               <div className="">
//                 <PdfComp pdfFile={selectedPdf} onLoadSuccess={handleLoadSuccess} />
//               </div>
//             </div>
//           </div>
...
//                 <div className="text-left">{totalPages}</div>
//               </div>
...
//                       onChange={() => handlePrintOptionChange("1")}
//                       className="mr-1"
//                     />
...
//                     <img src={grayscale} alt="grayscale" className="w-6 h-6 "></img>
//                     Grayscale
//                   </div>
//                 </button>
//                 <button className="hover:bg-orange-400 mb-3 mr-2 border border-gray-600 w-[250px] py-2  rounded-2xl">
//                   <div className="flex items-center justify-center">
//                     <img src={colored} alt="colored" className="w-6 h-6 mr-2"></img>
//                     Colored
//                   </div>
//                 </button>
